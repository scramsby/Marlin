...
#define STRING_CONFIG_H_AUTHOR "Scott Ramsby" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 403.05 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20.75, 0, -3.12 }
...
#define X_MIN_POS -6.85
#define Y_MIN_POS -89.8
#define Z_MIN_POS 0
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  -13, 52, (Z_MIN_POS + 2.5) } }
  #define NOZZLE_CLEAN_END_POINT   { { -6, 82, (Z_MIN_POS + 2.5) } }
